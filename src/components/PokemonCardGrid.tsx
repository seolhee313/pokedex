...
import { addPokemonToList } from "../app/redusers/addPokemonToList";
import { removePokemonFromUserList } from "../app/redusers/removePokemonFromUserList";
                      ...
                      return (
                        <div className="pokemon-card-types-type" key={index}>
                          <img
                            ...
                            loading="lazy"
                          />
                          <h6 className="pokemon-card-types-types-text">
                            {keys[0]}
                          </h6>
                        </div>
                      );
